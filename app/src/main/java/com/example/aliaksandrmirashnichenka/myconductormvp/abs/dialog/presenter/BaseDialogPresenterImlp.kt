...
abstract open class BaseDialogPresenterImlp<V: BaseView, M: BaseModel, D: DataHolder, A: DialogArguments, L: BaseDialogEventListener>(view: V, model: M, dataHolder: D, arguments: A, abs: Abs) :
